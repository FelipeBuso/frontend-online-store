    ...
    return (
      <div className="product-detail-container">
        ...
        <div className="product-detail-text-content-container">
          ...
          <p>Preço: { productDetail.price }</p>
          <p>Quantidade disponível: { productDetail.available_quantity }</p>
          <div className="product-detail-seller-data">
            <p>Informações do Vendedor</p>
            <p>Cidade: { productDetail.seller_address.city.name }</p>
            <p>Estado: { productDetail.seller_address.search_location.state.name }</p>
